...
const BILLS: Bill[] = [
  {
    ...
    lines: [
      { id: 'food', label: 'Food subtotal: Rs 810.00', illegal: false, why: 'Correct food total.' },
      { id: 'cgst', label: 'CGST @ 2.5%: Rs 20.25', illegal: false, why: 'Correct half of 5% GST.' },
      { id: 'sgst', label: 'SGST @ 2.5%: Rs 20.25', illegal: false, why: 'Correct half of 5% GST.' },
      { id: 'svc', label: 'Service charge @ 10%: Rs 81.00', illegal: true, why: 'Service charge cannot be forced on you (CCPA 2022). You can refuse it.' },
      { id: 'tot', label: 'Total payable: Rs 931.50', illegal: false, why: 'Math is fine — but remove the service charge line.' },
    ],
  },
  {
    id: 'b2',
    ...
    lines: [
      { id: 'food', label: 'Thali + juice: Rs 200.00', illegal: false, why: 'Correct subtotal.' },
      { id: 'gst18', label: 'GST @ 18%: Rs 36.00', illegal: true, why: 'Regular canteen food should be 5% GST, not 18%.' },
      { id: 'tot', label: 'Total: Rs 236.00', illegal: false, why: 'Total follows their wrong GST — flag the 18% line.' },
    ],
  },
  {
    id: 'b3',
    ...
    lines: [
      { id: 'food', label: 'Pizza + garlic bread: Rs 450.00', illegal: false, why: 'Correct subtotal.' },
      { id: 'gst', label: 'GST @ 5%: Rs 22.50', illegal: false, why: 'Correct GST on food.' },
      { id: 'pack', label: 'Packaging charge: Rs 30.00', illegal: true, why: 'Dine-in bill — no packaging or box charge.' },
      { id: 'tot', label: 'Total: Rs 502.50', illegal: false, why: 'Remove packaging to pay Rs 472.50.' },
    ],
  },
  {
    id: 'b4',
    name: 'Grand Hotel Restaurant',
    place: 'Luxury hotel · Room > Rs 7,500/night',
    note: '18% GST on food is allowed here — but extra fees still are not.',
    lines: [
      { id: 'food', label: 'Continental meal: Rs 400.00', illegal: false, why: 'Correct subtotal.' },
      { id: 'cgst', label: 'CGST @ 9%: Rs 36.00', illegal: false, why: 'Correct — half of 18% GST.' },
      { id: 'sgst', label: 'SGST @ 9%: Rs 36.00', illegal: false, why: 'Correct — half of 18% GST.' },
      { id: 'svc', label: 'Service charge @ 10%: Rs 40.00', illegal: true, why: 'Still optional — not a government tax.' },
      { id: 'tot', label: 'Total: Rs 512.00', illegal: false, why: 'GST lines are fine; refuse service charge.' },
    ],
  },
  {
    id: 'b5',
    ...
    lines: [
      { id: 'food', label: 'Samosa + chai: Rs 120.00', illegal: false, why: 'Correct subtotal.' },
      { id: 'gst', label: 'GST @ 5%: Rs 6.00', illegal: false, why: 'Correct GST.' },
      { id: 'tip', label: 'Mandatory gratuity: Rs 15.00', illegal: true, why: 'Same as forced service charge — you can say no.' },
      { id: 'fee', label: 'Convenience fee: Rs 20.00', illegal: true, why: 'Not a real tax. Challenge random add-on fees.' },
      { id: 'tot', label: 'Total: Rs 161.00', illegal: false, why: 'Pay Rs 126 without the illegal extras.' },
    ],
  },
];
  ...
  const tutorialPages: TutorialPage[] = [
    ...
    },
    {
      ...
      terms: [
        ...
        { id: 'r18', label: '18%', fullForm: 'Luxury hotel restaurants', meaning: 'Only when the hotel room tariff is above Rs 7,500/night.' },
      ],
    ...
    },
    {
      ...
      formula: '5% total = 2.5% CGST + 2.5% SGST\nRs 400 food → Rs 10 + Rs 10 → Rs 420 total',
    },
    {
      title: 'NOT A TAX',
      terms: [
